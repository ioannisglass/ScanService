...
namespace ScanApp
{
    ...
    {
        public static void StartService(string serviceName = "ScanService", int timeoutMilliseconds = 1000)
        {
        ...
        public static void StopService(string serviceName = "ScanService", int timeoutMilliseconds = 3000)
        {
            ServiceController service = new ServiceController(serviceName);
            try
            {
        ...
        public static void RestartService(string serviceName = "ScanService", int timeoutMilliseconds = 3000)
        {
            ServiceController service = new ServiceController(serviceName);
            try
            {
        ...
        public static void InstallService()
        {
            ...
            string cmd = "InstallUtil.exe ScanService.exe";
        ...
        public static bool IsServiceInstalled(string service_name = "ScanService")
        {
            return ServiceController.GetServices().Any(s => s.ServiceName == service_name);
        }

        public static string GetWindowsServiceStatus(string SERVICENAME =  "ScanService")
        {
